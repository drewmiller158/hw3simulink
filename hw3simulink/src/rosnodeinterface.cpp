...
//
// Code generated for Simulink model 'hw3'.
//
// Model version                  : 1.2
// Simulink Coder version         : 24.1 (R2024a) 19-Nov-2023
// C/C++ source code generated on : Thu Oct 31 09:59:04 2024
//
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"hw3\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(hw3_M, (NULL));
        hw3_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(hw3_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(hw3_M)
                == (NULL)) || rtmGetStopRequested(hw3_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(hw3_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
